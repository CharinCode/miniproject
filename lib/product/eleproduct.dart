...
class ProductElectronics extends StatefulWidget {
  const ProductElectronics({super.key});

  @override
  State<ProductElectronics> createState() => _ProductElectronicsState();
}

class _ProductElectronicsState extends State<ProductElectronics> {
  ...
  Future<List> getApiShopping() async {
    ...
    if (response.statusCode == 200) {
      ...
      List eleproductClothingProducts = shopdata
          .where((product) => product['category'] == "electronics")
          .toList();
      log(eleproductClothingProducts.length.toString());
      return eleproductClothingProducts;
    } else {
