...
class ProductJewelry extends StatefulWidget {
  const ProductJewelry({super.key});

  @override
  State<ProductJewelry> createState() => _ProductJewelryState();
}

class _ProductJewelryState extends State<ProductJewelry> {
  late List<dynamic> listShopping;
  ...
  Future<List> getApiShopping() async {
    ...
    if (response.statusCode == 200) {
      ...
      List jewlryClothingProducts = shopdata
          .where((product) => product['category'] == "jewelery")
          .toList();

      return jewlryClothingProducts;
    } else {
